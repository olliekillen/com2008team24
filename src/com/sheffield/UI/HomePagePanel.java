...
public class HomePagePanel extends JPanel {
    ...
    public HomePagePanel(MyFrame myFrame){
        ...
        CustomJTextArea welcomePara1 = new CustomJTextArea(paragraph, 15);
        add(welcomePara1);
        ...
        CustomJTextArea welcomePara2 = new CustomJTextArea(paragraph, 15);
        add(welcomePara2);
        ...
        CustomJTextArea welcomePara3 = new CustomJTextArea(paragraph, 15);
        add(welcomePara3);
